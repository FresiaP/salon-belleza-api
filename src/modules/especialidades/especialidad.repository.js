...
const especialidad_repository = {
    ...
    async getEspecialidades({ page = 1, limit = 10, search, estado, sort, dir }) {
        ...
        // =========================================
        const allowedSortFields = ["id_especialidad", "nombre_especialidad", "estado"];
        const sortField = allowedSortFields.includes(sort) ? sort : "id_especialidad";
    ...
    async updateEspecialidad(id_especialidad, { nombre_especialidad, estado, modificado_por }) {
        const pool = await poolPromise;
